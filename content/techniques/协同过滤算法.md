...
graph TB
    ...
    U3 -->|评分3⭐| I2
    U3 -->|评分4⭐| I4
    style U1 fill:#1e3245,color:#cdd6f4    style U2 fill:#1e3245,color:#cdd6f4    style U3 fill:#1e3245,color:#cdd6f4    style I1 fill:#1e3a28,color:#cdd6f4    style I2 fill:#1e3a28,color:#cdd6f4    style I3 fill:#1e3a28,color:#cdd6f4    style I4 fill:#1e3a28,color:#cdd6f4```
...
flowchart LR
    ...
    P --> |内积重建| R2["预测矩阵 R̂\n(填补缺失值)"]
    Q --> |内积重建| R2
    style M fill:#4a3e1a,color:#cdd6f4    style R2 fill:#1e3a28,color:#cdd6f4```
